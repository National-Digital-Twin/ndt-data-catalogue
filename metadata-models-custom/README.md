...
Before proceeding further, make sure you understand the DataHub Metadata Model concepts defined [here](/docs/metadata-modeling/metadata-model) and extending the model defined [here](/docs/modeling/extending-the-metadata-model.md).
